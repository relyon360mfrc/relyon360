...
>
> **Status:** 🟠 **Modelo documentado (estado atual + alvo proposto). Nada redesenhado ainda.**
> Documento criado em 2026-06-18 na Fase 0 do plano "Organizar Usuários e Níveis de Acesso".
> As Fases A (UI) e B (banco) aguardam decisão (ver §7 — Decisões em aberto).
...
| `customer_service` | usuário-sistema | 1 base | `isCS` — `js/auth.js:271` |
